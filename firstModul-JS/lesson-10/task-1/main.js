 ...
 * usersOnlineNames”, где usersOnlineNames - строка, в которой имена пользователей отображаются через запятую.
...
const usersOnlineName = usersOnline.map((name) => name.username).join(', ');
